...
public interface ComplaintKeywordStaffMappingRepository extends JpaRepository<ComplaintKeywordStaffMapping, String> {
    @Query("select c from ComplaintKeywordStaffMapping c where c.staffId = :staffId")
    public List<ComplaintKeywordStaffMapping> findByStaffId(@Param("staffId") String staffId);
}
